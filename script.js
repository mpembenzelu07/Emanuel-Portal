// ==================== ENHANCED DATA (15+ academies with rich details) ====================
const academies = [
  // Temeke (3)
...
function renderDistrictPage(districtName) {
  ...
  if (filtered.length === 0) {
    container.innerHTML = '<p style="text-align:center;">No academies found in this district.</p>';
    return;
  }
...
function loadAcademyDetail() {
  ...
  container.innerHTML = `
    <div class="detail-card">
      ...
      <div class="info-row"><i class="fas fa-chalkboard-user"></i> Head Coach: ${academy.coach}</div>
      <div class="info-row"><i class="fas fa-phone-alt"></i> ${academy.contact} 
...
// Auto-run if on appropriate pages
